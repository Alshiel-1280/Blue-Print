...
`v1.0.0` — 初回安定版。記帳、証憑、請求・支払、決算、申告、弥生移行、暗号化バックアップをローカルファーストで提供します。

実装順と完了条件は [plan.md](./plan.md)、要求の基準は [要件定義書.md](./要件定義書.md)、配布物と既知の制限は [v1.0.0リリースノート](./docs/release/v1.0.0.md) を参照してください。
