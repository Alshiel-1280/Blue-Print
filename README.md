...
`v1.0.0` — 初回安定版の署名・公証検証中です。記帳、証憑、請求・支払、決算、申告、弥生移行、暗号化バックアップまで実装し、公開前の配布ゲートを確認しています。

実装順と完了条件は [plan.md](./plan.md)、要求の基準は [要件定義書.md](./要件定義書.md)、公開ゲートと既知の制限は [v1.0.0公開案内](./docs/release/v1.0.0-draft.md) を参照してください。
