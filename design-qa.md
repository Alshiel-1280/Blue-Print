...
- Design-system source: `docs/design/option-2-unified-direction.png`
- Implementation: `artifacts/v1-prep/design-qa/backup-onboarding.png`
- Full comparison: `artifacts/v1-prep/design-qa/reference-vs-backup-onboarding.png`
- Detailed report: `artifacts/v1-prep/design-qa/design-qa.md`

月次タスク画面を案2のスタイル基準として、白い面、太い見出し、グレーの説明、青い主操作、抑制した副操作、橙の注意領域を比較した。初回バックアップ案内は560 pt幅のネイティブシートとして読み順と操作の主従が明確で、切れ・重なり・不正な余白はない。P0、P1、P2の未解決事項はない。
